...
const NotFound = () => {
  return (
    <div className="min-h-[70vh] flex flex-col justify-center items-center text-center px-6">
      ...
      <h2 className="text-3xl font-semibold mt-4 text-gray-800">უი! გვერდი ვერ მოიძებნა</h2>
      <p className="text-gray-600 mt-2 mb-8">როგორც ჩანს, ეს მისამართი ჩვენს მენიუში არ არის.</p>
      <Link 
        to="/" 
