...
const About = () => {
  ...
  return (
    <Section
      title="ჩვენს შესახებ"
      subtitle="Cafe Moon — ადგილი, სადაც ტრადიცია და თანამედროვეობა ხვდება ერთმანეთს."
    >
      <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
        <div className="md:w-1/2">
          <img
            src="https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=600&q=60"
            srcSet="https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=400&q=60 400w,
                    https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=800&q=60 800w"
          ...
          {[
            {
              year: "2020",
              title: "დაარსება",
              desc: "გაიხსნა პირველი Cafe Moon ქუთაისში, 15 ადგილით.",
            },
            {
              year: "2021",
              title: "მენიუს გაფართოება",
              desc: "დესერტებისა და საავტორო სასმელების ხაზი დაემატა.",
            },
            {
              year: "2023",
              title: "რენოვაცია",
              desc: "ინტერიერი განახლდა moon-თემატიკის დიზაინით.",
            },
            {
              year: "2024",
              title: "ონლაინ შეკვეთა",
              desc: "გაეშვა ვებ-საიტი მიტანის სერვისით ქუთაისში.",
            },
          ].map((item) => (
            <div
              key={item.year}
      ...
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              icon: "☕",
              title: "ხარისხიანი ყავა",
              desc: "ვიყენებთ 100% არაბიკას მარცვლებს, რომლებიც სპეციალურად არის შერჩეული და მოხალული.",
            },
            {
              icon: "🍰",
              title: "ხელნაკეთი დესერტები",
              desc: "ჩვენი შეფ-მზარეული ყოველდილით ამზადებს ახალ დესერტებს ნატურალური ინგრედიენტებით.",
            },
            {
              icon: "🏠",
              title: "მყუდრო გარემო",
              desc: "უნიკალური ინტერიერი moon-თემატიკით, კომფორტული ადგილები მუშაობისა და დასვენებისთვის.",
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      <div className="bg-gray-900 rounded-3xl p-10 md:p-14 text-white">
        <h3 className="text-2xl font-bold text-center mb-10 italic">
          რიცხვებში
        </h3>
