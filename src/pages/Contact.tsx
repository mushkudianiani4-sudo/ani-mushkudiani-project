    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-50">
          <h3 className="text-2xl font-bold text-gray-800 mb-6 italic">მოგვწერეთ</h3>
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            <div>
              ...
              {formik.touched.name && formik.errors.name ? (
                <div className="text-red-500 text-sm mt-1 ml-2 font-medium">{formik.errors.name}</div>
              ) : null}
            </div>
            ...
            <div>
              ...
              {formik.touched.email && formik.errors.email ? (
                <div className="text-red-500 text-sm mt-1 ml-2 font-medium">{formik.errors.email}</div>
              ) : null}
            </div>
            ...
            <div>
              ...
              {formik.touched.message && formik.errors.message ? (
                <div className="text-red-500 text-sm mt-1 ml-2 font-medium">{formik.errors.message}</div>
              ) : null}
            </div>
